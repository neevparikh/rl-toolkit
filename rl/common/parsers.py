...
common_parser.add_argument('--output-path', default='rl_logs', type=str, required=False,
...
common_parser.add_argument('--batchsize', type=float_to_int, required=False, default=32,
...
async_dqn_parser.add_argument('--num-send-transitions', type=int, required=False, default=32,
        help='Number of local transitions to batch for actor')
async_dqn_parser.add_argument('--min-gradient-steps', type=float_to_int,
        required=False, default=1e3,
        help='Minimum gradient steps for learner')
